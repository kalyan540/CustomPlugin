...
const Styles = styled.div<SupersetPluginChartAssessmentStylesProps>`
...
export default function SupersetPluginChartAssessment(props: SupersetPluginChartAssessmentProps) {
